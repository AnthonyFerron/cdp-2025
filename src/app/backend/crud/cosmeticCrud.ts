...
import { Cosmetic, CosmeticDb, CosmeticType } from "../models/cosmetic/cosmetic.model";
...
export default class CosmeticCrud extends ConfigCrud {
    ...
    async createCosmetic(type: CosmeticType, price: number, isActive: boolean, image: string, name: string) {
        try {
