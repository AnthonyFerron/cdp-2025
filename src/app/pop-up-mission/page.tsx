  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl text-center">
        ...
        {/* Contenu centré */}
        <div
          className="absolute inset-0 flex flex-col items-center justify-end text-black px-6 py-10 gap-12"
          style={{
        ...
        >
          <div>
            ...
            <p className="text-2xl sm:text-3xl mb-5">Bravo ! Vous avez accompli cette mission.</p>

            <p className="text-2xl sm:text-3xl mb-10 flex items-center justify-center gap-3">
              Vous avez reçu 300 XP !
              <img src="/img/feu_emoji.png" alt="feu" className="w-8 h-8" />
            </p>
          </div>
