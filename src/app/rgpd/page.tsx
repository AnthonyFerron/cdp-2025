    ...
    <div className="font-[silkscreen] bg-[#0e0f12] text-gray-300">
      ...
      <div className="min-h-screen p-6 md:p-12">
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-[#00c6ff] mb-2">• INTRODUCTION</h2>
          <div className="bg-[#251F1F] rounded-xl p-6 text-sm leading-relaxed">
            Bienvenue sur GamiCode.<br /><br />
            Nous accordons une grande importance à la protection de vos données personnelles.
            Cette politique explique comment vos informations sont collectées, utilisées et protégées lorsque vous utilisez notre site de réservation de concerts.
          </div>
        </section>
