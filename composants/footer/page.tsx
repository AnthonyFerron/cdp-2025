      ...
      >
        <div className="relative z-10 flex flex-col items-start text-left px-6 pb-4 mb-14">
          ...
          <div className="flex items-center gap-2 mb-3">
            <Link href="/sign-up" className="text-2xl text-black">
              Inscription
            </Link>
            <span aria-hidden className="mx-3 text-2xl text-black">
              |
            </span>
            <Link href="/sign-in" className="text-2xl text-black">
              Connexion
            </Link>
          </div>

          <p className="mb-4 text-2xl text-black">
            <Link href="/cgi" className="hover:underline">
              CGI
            </Link>
    ...
    >
      <div className="relative z-10 flex flex-col items-start text-left px-6 pb-4 mb-14">
        ...
        <div className="mb-4 flex items-center gap-2">
          <Link href="/missions" className="text-2xl text-black">
            Missions
          </Link>
          <span aria-hidden className="mx-3 text-2xl text-black">
            |
          </span>
          <Link href="/boutique" className="text-2xl text-black">
            Boutique
          </Link>
          <span aria-hidden className="mx-3 text-2xl text-black">
            |
          </span>
          <Link href="/profil" className="text-2xl text-black">
            Mon compte
          </Link>
        </div>
